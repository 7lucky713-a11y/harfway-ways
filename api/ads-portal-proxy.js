...
function patchRootHtml(text) {
  const scripts = [
    ...
    '<script src="/ads-portal-preview-top-strip-trim-v5.js"></script>',
...
export default async function handler(req, res) {
  ...
  try {
    ...
    res.setHeader('X-HARFWAY-ADS-PORTAL', 'video-10mb-r2-image-3mb-sale-placement-standalone-preview-device-layout-v4-media-guard-pc-fit-top-strip-trim-v5');
