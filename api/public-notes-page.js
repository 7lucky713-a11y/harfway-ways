...
function navHeader(demo=false){
 return `${demo?'<div class="sample">プレビュー用のサンプルです。実データには接続していません。</div>':''}<header class="site-header"><div class="header-inner"><div class="brand"><a href="/notes/${demo?'?demo=1':''}" aria-label="プレイノートのトップへ">HARF-WAY<i>/</i><span>プレイノート</span></a></div><nav class="nav" aria-label="サイト内メニュー"><a class="active" href="/notes/">プレイノート</a><a href="/words/">用語解説 ↗</a><a href="https://harf-way.com/">HARF-WAY ↗</a></nav></div></header>`;
}
