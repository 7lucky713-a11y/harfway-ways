...
function normalizeSetCookie(cookie) {
  return cookie.replace(/;\s*Domain=[^;]*/ig, '').replace(/;\s*Path=[^;]*/ig, '; Path=/');
}

function copyResponseHeaders(upstream, res) {
  const blocked = new Set(['connection','content-length','content-encoding','transfer-encoding','access-control-allow-origin','access-control-allow-credentials','access-control-allow-headers','access-control-allow-methods','set-cookie']);
