...
export default async function handler(req, res) {
  ...
  try {
    ...
    const embedUrl = `${origin}/embed/${encodedId}`;
    const waysUrl = `${origin}/?game=${encodedId}&utm_source=ways_share&utm_medium=share_link&utm_campaign=ways_game_share&utm_content=${encodedId}`;
