(() => {
  ...
  function installStyles(){
    ...
    const style=document.createElement('style');style.id='game-note-publication-styles';style.textContent=`
      ...
      @media(max-width:700px){.gn-publication{width:100%;order:-1}.gn-publication button,.gn-publication a{flex:1;text-align:center;min-width:130px}.gn-publication-help{flex-basis:100%}}
