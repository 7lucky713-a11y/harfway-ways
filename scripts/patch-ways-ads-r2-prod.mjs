...
if (source.includes(desktopBefore)) source = source.replace(desktopBefore, desktopAfter);
else if (!source.includes(desktopAfter)) throw new Error('[ways-ads-r2] desktop click block not found');
...
console.log('[ways-ads-r2] fair-v2 serve + direct visual sponsor link applied');
